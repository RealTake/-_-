...
public class BoardService {
	...
	public String getSearchPostList_S(String content, int pageNum, Authentication authentication) {
	    ...
	    int end = pageNum * 10;// 가져올 글 목록들의 끝 인덱스를 계산
        ...
        try {
            ...
            printInfo(new Object(){}.getClass().getEnclosingMethod(), approach, auth_S);// 실행중인 메소드 정보 호출
        }
...
//	}
    ...
    public String modifyPost_S(String bid, BoardDTO dto, Authentication authentication) {// 작성글의 리스트를 보여주는 메서드
    ...
    public void printInfo(Method nowmethod, String name, String auth)// 서비스 메소드 정보 호출
    {
